...
class login_window:
    def __init__(self,root):
        ...
        id_user = Label(frame1,text="MatricNum",font=("times 18 bold"),bg="white",fg="black")
        id_user.place(x=15,y=175)
    ...
    def login(self):
        if self.id_box.get()=="" or self.pass_box.get()=="":
            ...
            my_cursor.execute("select * from registered where Matric Number=%s and pass=%s",(self.id_box.get(),self.pass_box.get(),))
